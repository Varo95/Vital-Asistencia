...
public class MainActivity extends AppCompatActivity implements IList.View {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        items.add(b);
        BUser c=new BUser();
        c.setAffiliate_number("113AAAAA");
        c.setEmail("test2@test2.com");
        c.setAddress("C/ Ejemplo2");
        items.add(c);
        BUser d=new BUser();
        d.setAffiliate_number("114AAAAA");
        d.setEmail("test3@test3.com");
        d.setAddress("C/ Ejemplo3");
        items.add(d);
        BUser e=new BUser();
        e.setAffiliate_number("115AAAAA");
        e.setEmail("test4@test4.com");
        e.setAddress("C/ Ejemplo4");
        items.add(e);
        BUser f=new BUser();
        f.setAffiliate_number("116AAAAA");
        f.setEmail("test5@test5.com");
        f.setAddress("C/ Ejemplo5");
        items.add(f);
        BUser g=new BUser();
        g.setAffiliate_number("117AAAAA");
        g.setEmail("test6@test6.com");
        g.setAddress("C/ Ejemplo6");
        items.add(g);
        BUser h=new BUser();
        h.setAffiliate_number("118AAAAA");
        h.setEmail("test7@test7.com");
        h.setAddress("C/ Ejemplo7");
        items.add(h);
